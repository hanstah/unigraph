...
const GoogleMapsView: React.FC<GoogleMapsViewProps> = ({ theme, ...props }) => {
  const [selectedLocation, setSelectedLocation] = useState<Location | null>(
    null
  );
  const [mapType, setMapType] = useState<
    "roadmap" | "satellite" | "terrain" | "dark"
  >("roadmap");

  // Sample locations - in a real app, these would come from props or API
  ...
  const mapCenter = useMemo(() => ({ lat: 37.7749, lng: -122.4194 }), []); // San Francisco
