...
//     const source = graph.createNode("SourceNode");
//     const target = graph.createNode("TargetNode");
...
//     const node1 = graph.createNode("Node1", { tags: ["tag1"] });
//     const node2 = graph.createNode("Node2", { tags: ["tag2"] });
